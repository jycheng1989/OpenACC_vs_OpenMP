...
!OpenMP 5.x with reduction and atomic
module particle
   implicit none
...
Program test
   ...
   !endif
   write(*,*)'OpenMP 5x: total time is', totalTime
...
subroutine testKernel()
   ...
   !$omp target teams loop reduction(+: outOfBoundaryOfParticle1, outOfBoundaryOfParticle2, outOfBoundaryOfParticle3)
